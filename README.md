...
- Install Python package **[pip](https://pypi.org/project/pip/)**:
   ```
...
- On execution, the code will create a copy of the workbook. All changes will be made to the newly created workbook and the same will be uploaded to the BAR Tool. The newly created workbook will be present in a newly created directory. The naming convention of the directory is **newWorkbookFile_*date(time)*** and that of the workbook is **OfflineCustomerWorkbook-v200330081105_*date(time)*.xlsm**.
